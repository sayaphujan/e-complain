<?php
$nama_file = "Laporan Data Komplain -_-".$filter.'-_-'.$key.".xls";    
...
<style type="text/css">
            ...
            <center>
              ...
              <h3 class="box-title"><b>LAPORAN DATA USER e-Complaint PCM Bligo</b></h3>
               <p>Berdasarkan <?php echo ucfirst($filter); ?></p>
            ...
            <tbody>
              ...
              echo"
                  <tr>
                    ...
                    <td>".strtoupper($value['nama_grup'])."</td>
                    <td>".strtoupper($value['nama_aum'])."</td>
                    <td>".ucfirst($value['judul_complain'])."</td>
                    <td>".strtoupper($value['jenis_complain'])."</td>
                    <td>".$value['tgl_complain']."</td>
                    <td>".$value['solusi']."</td>
                    <td>".$value['status_complain']."</td>
                  </tr>
              ";
                    }
              ?>

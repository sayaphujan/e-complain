...
$nama_file = "Laporan Data Masuk-_-".$tawl.'-_-'.$takh.".xls";    
...
<style type="text/css">
            ...
            <center>
              ...
              <hr/>
              <h3 class="box-title"><b>LAPORAN DATA MASUK</b></h3>
            ...
            <tbody>
              ...
              $no=1;
                    foreach ($tampil->result_array() as $key => $value) {
                        $tmhn = $value['tgl_complain'];
                        $tglm  = substr($tmhn, -2);
                        $blnm  = substr($tmhn, 5, 2);
                        $thnm  = substr($tmhn, 0, 4);
                        $tglmohon = $tglm.'/'.$blnm.'/'.$thnm;
              echo"
                  <tr>
                    <td>".$no++."</td>
                    ...
                    echo "<td>".ucfirst($value['jenis_complain'])."</td>
                    <td>".$tglmohon."</td>
                  </tr>
              ";
                    }

...
$nama_file = "Laporan Data Status Komplain -_-".$tawl.'-_-'.$takh.".xls";    
...
<style type="text/css">
            ...
            <center>
              ...
              <hr/>
              <h3 class="box-title"><b>LAPORAN DATA STATISTIK e-Complaint PCM Bligo</b></h3>
               <p>Berdasarkan Status Komplain</p>
           ...
           <thead>
            ...
            <tbody>
              ...
              echo"<tr><td colspan=6><b>TOTAL</b></td><td>".$value['total']."</td></tr>";
              ?>
            </tbody>
        </table>
        <br /><br />
